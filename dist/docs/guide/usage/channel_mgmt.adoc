...
Use the --full parameter for a complete overview.
wildfly-test org.wildfly.channels:wfly-27
----

As described, you can use the `--full` paramenter for a complete channel information.

[bash, source]
----
$ ./prospero.sh channel list --dir wfly-27 --full
Server /tmp/wfly-27 is subscribed to following channels:
