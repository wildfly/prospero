...
public class UpdateToVersionTest {
    ...
    public void prepareUpdate_upgradeToLatestVersion() throws Exception {
        ...
        assertThat(installationManager().prepareUpdate(candidatePath, Collections.emptyList())).isTrue(); // No target manifest version given
    ...
    public void prepareUpdate_upgradeToSpecificVersion() throws Exception {
        ...
        assertThat(installationManager().prepareUpdate(candidatePath, Collections.emptyList(), List.of(manifestVersion))).isTrue();
    ...
    public void findUpdates_toLatestVersion() throws Exception {
        ...
        List<ArtifactChange> updates = installationManager().findUpdates(Collections.emptyList()); // No target manifest version given

       assertThat(updates.size()).isEqualTo(1);
       assertThat(updates.get(0).getNewVersion()).isEqualTo("2.18.0.CP-02");
    }
